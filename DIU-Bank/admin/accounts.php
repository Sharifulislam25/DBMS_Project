...
// Get approved users for account creation
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchForm.addEventListener('submit', function() {
                ...
                // Re-enable after a short delay (for better UX feedback)
                setTimeout(function() {
        ...
        // Handle balance modal data population
        ...
        document.getElementById('deleteAccountModal').addEventListener('show.bs.modal', function (event) {
            ...
            // Show warnings based on account status
            var warnings = [];
        ...
        function updateAccountDeleteButtons() {
            ...
            // Disable buttons if account has balance
            if(currentAccountBalance > 0) {
